...
export const getCargoTypeAddress = (
  ...
  cargoStatsDefinitionSeqId: number = 1
) =>
  SagePrograms.pipe(
...
class GetPlayerProfileError extends Data.TaggedError("GetPlayerProfileError")<{
...
class PlanetNotFoundError extends Data.TaggedError("PlanetNotFoundError")<{
